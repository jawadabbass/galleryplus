            ...
            <div class="card-body login-card-body">
                ...
                <form method="POST" action="{{ route('admin.register') }}">
                    ...
                    <div class="input-group mb-3">
                        {{-- <x-backend.form.label for="name" :value="__('Name')" /> --}}
                        <x-backend.form.input id="name" class="form-control" type="text" name="name" :value="old('name')" required
                            autofocus placeholder="Name" />
                        <x-backend.form.input-append class="fas fa-user" />
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <x-backend.form.input id="password" class="form-control" type="password" name="password" :value="old('password')"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <x-backend.form.input id="password_confirmation" class="form-control" type="password" name="password_confirmation" :value="old('password_confirmation')"
                            required placeholder="Confirm Password" autocomplete="current-password" />
                        <x-backend.form.input-append class="fas fa-lock" />
                    </div>
                    <div class="row">
                        <div class="col-8"></div>
